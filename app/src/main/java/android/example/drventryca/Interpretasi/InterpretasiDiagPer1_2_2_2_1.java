...
public class InterpretasiDiagPer1_2_2_2_1 {
    ...
    public InterpretasiDiagPer1_2_2_2_1(ArrayList<QuestionModel> questionModels){
    ...
    public void spk()
    {
        ...
        /*for (int i = 0; i < position; i++) {
                    ...
                    questionModels.get(4).isAnswer() == true)
            {
                ...
                setDiagnosis("Segera periksakan diri anda ke dokter");
                    ...
                    questionModels.get(4).isAnswer() == true)
            {
                Log.d("diagnosis", "Penyakit Demam Tifoid (Tipus)");
                setDiagnosis("Demam Tifoid (Tipus)");
            }
            ...
            {
                Log.d("diagnosis", "Entritis");
                setDiagnosis("Entritis");
            }
        ...
        if (hitungP1 > hitungP2) {
            ...
            setDiagnosis("Demam Tifoid (Tipus), Anda memenuhi " + hitungP1 + " dari 6 gejala yang ada \n" + "Entritis, anda memenuhi " +
