...
import android.example.drventryca.Interpretasi.InterpretasiDiagPer2_2;
...
public class DiagPerPart2_2 extends AppCompatActivity {
        ...
        submit.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                if (progres == questionModels.size()){
                    ...
                    InterpretasiDiagPer2_2 interpretasiDiagPer2_2 = new InterpretasiDiagPer2_2(questionModels);
                    interpretasiDiagPer2_2.spk();
                    Intent intent = new Intent(DiagPerPart2_2.this, ResultDiag.class);
                    intent.putExtra("key", interpretasiDiagPer2_2.getDiagnosis());
    ...
    public void initializeDiagPerPart2_2(){
        String[] question = getResources().getStringArray(R.array.question_per2_2);
