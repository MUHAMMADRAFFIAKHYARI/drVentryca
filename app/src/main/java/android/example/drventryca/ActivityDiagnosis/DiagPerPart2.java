        ...
        submit.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                if (progres == questionModels.size()){
                    ...
                    InterpretasiDiagPer3_1 interpretasiDiagPer31 = new InterpretasiDiagPer3_1(questionModels);
                    interpretasiDiagPer31.spk();
                    Intent intent = new Intent(DiagPerPart2.this, ResultDiag.class);
                    intent.putExtra("key", interpretasiDiagPer31.getDiagnosis());
