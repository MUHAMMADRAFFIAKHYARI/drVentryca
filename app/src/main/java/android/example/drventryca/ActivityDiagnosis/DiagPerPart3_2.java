...
import android.example.drventryca.Interpretasi.InterpretasiDiagPer3_2;
...
public class DiagPerPart3_2 extends AppCompatActivity {
        ...
        submit.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                if (progres == questionModels.size()){
                    ...
                    InterpretasiDiagPer3_2 interpretasiDiagPer3_2 = new InterpretasiDiagPer3_2(questionModels);
                    interpretasiDiagPer3_2.spk();
                    Intent intent = new Intent(DiagPerPart3_2.this, ResultDiag.class);
                    intent.putExtra("key", interpretasiDiagPer3_2.getDiagnosis());
    ...
    public void initializeDiagPerPart3_2(){
        String[] question = getResources().getStringArray(R.array.question_per3_2);
