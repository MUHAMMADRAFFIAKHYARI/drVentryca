...
import android.example.drventryca.Interpretasi.InterpretasiDiagPer2_1;
...
public class DiagPerPart2_1 extends AppCompatActivity {
        ...
        submit.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                if (progres == questionModels.size()){
                    ...
                    InterpretasiDiagPer2_1 interpretasiDiagPer2_1 = new InterpretasiDiagPer2_1(questionModels);
                    interpretasiDiagPer2_1.spk();
                    Intent intent = new Intent(DiagPerPart2_1.this, ResultDiag.class);
                    intent.putExtra("key", interpretasiDiagPer2_1.getDiagnosis());
    ...
    public void initializeDiagPerPart2_1(){
        String[] question = getResources().getStringArray(R.array.question_per2_1);
