...
import android.example.drventryca.Interpretasi.InterpretasiDiagPer1_2_2_1;
...
public class DiagPerPart1_2_2_1 extends AppCompatActivity {
        ...
        submit.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                if (progres == questionModels.size()){
                    ...
                    InterpretasiDiagPer1_2_2_1 interpretasiDiagPer1_2_2_1 = new InterpretasiDiagPer1_2_2_1(questionModels);
                    interpretasiDiagPer1_2_2_1.spk();
                    Intent intent = new Intent(DiagPerPart1_2_2_1.this, ResultDiag.class);
                    intent.putExtra("key", interpretasiDiagPer1_2_2_1.getDiagnosis());
    ...
    public void initializeDiagPerPart1_2_2_1(){
        String[] question = getResources().getStringArray(R.array.question_per1_2_2_1);
