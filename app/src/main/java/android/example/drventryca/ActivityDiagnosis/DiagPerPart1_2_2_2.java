...
public class DiagPerPart1_2_2_2 extends AppCompatActivity {

    RadioGroup radioGroup_per1_2_2_2;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_diag_per_part1_2_2_2);
        radioGroup_per1_2_2_2 = (RadioGroup) findViewById(R.id.radiogroup_per1_2_2_2);

        radioGroup_per1_2_2_2.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
